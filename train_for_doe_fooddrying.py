...
for epoch in range(10):
    ...
    for i in range(random_step_size):
        action_output = [0.4, env.action_space[0].sample().item(), env.action_space[1].sample().item(), 0.5, 273.15 + 46,
    ...
    for step in range(i+1,max_step):
        ...
        # step action
        action_input = [(0.4-0.25)/(0.8-0.25), actions[0].item(), actions[1].item(), (0.5-0.3)/0.3, (46-30)/30,
                  actions[2].item()]
