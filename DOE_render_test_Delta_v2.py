...
for epoch in range(num_epoch):
    ...
    for step in range(max_step):
        ...
        action_input = np.array([0., actions[0].item(), actions[1].item(), 0., 0.,
                                 actions[2].item()])
        action_output = action_lower_bounds + action_input * action_delta_bounds + action_offset
