...
class hyper_parameters():
    ...
    def parse_args_maddpg(self):
        ...
        parser.add_argument("--actor_states_dims", type=list, default=[5,5,5], help="The dimensions of the input ActorNetwork of all agents are eg:[3, 3]. Among them, the dimensions of the state information of 2 agents' acquisition actions are 3 3 respectively.")
