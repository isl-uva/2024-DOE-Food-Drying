...
class DymolaEnv(Env):
    def __init__(self):
        ...
        with open("modelica_input_data.txt", 'r') as file:
            for line in file:
                ...
                weather_af.append(float(parts[1]))
                weather_tp.append(float(parts[2]))

        self.weather_af=weather_af
    ...
    def step(self, action):
        ...
        agents_dict['agent_2']=[self.state[9]]
        agents_dict['agent_2'].append(self.state[10])
        agents_dict['agent_2'].append(self.state[21])
        agents_dict['agent_2'].append(self.state[22])

        # Damper observation
        agents_dict['agent_3']=[self.state[18]]
        agents_dict['agent_3'].append(self.state[19])
        agents_dict['agent_3'].append(self.state[27])
        agents_dict['agent_3'].append(self.state[28])
